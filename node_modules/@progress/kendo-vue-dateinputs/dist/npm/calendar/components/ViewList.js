...
exports.ViewListVue2 = exports.ViewList = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var ViewListVue2 = {
  ...
  computed: {
    weekNames: {
      get: function get() {
        ...
        var weekNames = (0, utils_1.shiftWeekNames)(this._intl.dateFormatNames({
          nameType: 'short',
          type: 'days'
        }), this._intl.firstDay());
    ...
    weekNumber: {
      get: function get() {
        return Boolean(this.$props.showWeekNumbers && this.$props.activeView === main_1.CalendarViewEnum.month);
      }
    }
  },
  ...
  methods: {
    ...
    calculateHeights: function calculateHeights() {
      ...
      var scrollableHeight = this.$props.activeView === main_1.CalendarViewEnum.month ? this.$props.dom.scrollableContentHeight : this.$props.dom.scrollableYearContentHeight;
  ...
  render: function render(createElement) {
    ...
    var rootClassNames = (0, kendo_vue_common_1.classNames)('k-calendar-view', 'k-hstack k-align-items-start k-justify-content-center', {
      'k-calendar-monthview': this.$props.activeView === main_1.CalendarViewEnum.month,
      'k-calendar-yearview': this.$props.activeView === main_1.CalendarViewEnum.year,
    ...
    var buildDates = function buildDates() {
      ...
      return this.$props.dates.map(function (vDate) {
        ...
        }, [this.$props.activeView === main_1.CalendarViewEnum.month && buildMonthView.call(this, this.weekNames),
