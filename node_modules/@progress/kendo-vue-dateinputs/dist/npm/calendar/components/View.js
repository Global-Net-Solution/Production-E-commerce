...
exports.ViewVue2 = exports.View = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var ViewVue2 = {
  ...
  computed: {
    ...
    isMonthView: {
      get: function get() {
        return this.$props.activeView === main_1.CalendarViewEnum.month;
      }
    },
    weekNumber: {
      get: function get() {
  ...
  methods: {
    getWeekNumber: function getWeekNumber(date) {
      ...
      return (0, kendo_date_math_1.weekInYear)(date, this._intl.firstDay());
    },
    ...
    handleMouseEnter: function handleMouseEnter(value) {
      this.$emit('cellenter', (0, kendo_date_math_1.cloneDate)(value));
    },
    handleMouseLeave: function handleMouseLeave(value) {
      this.$emit('cellleave', (0, kendo_date_math_1.cloneDate)(value));
    }
  },
  // @ts-ignore
  ...
  render: function render(createElement) {
    ...
    this._weekService = new main_2.WeekNamesService(this._intl);
