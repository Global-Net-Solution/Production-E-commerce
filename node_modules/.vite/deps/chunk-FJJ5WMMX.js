...
var ref3 = allVue4.ref;
var inject3 = allVue4.inject;
var TabStripVue2 = {
  name: "KendoTabStrip",
  // @ts-ignore
  emits: {
  ...
  render: function render4(createElement) {
    ...
    var componentClasses = classNames("k-widget", "k-pos-relative", "k-tabstrip", (_a3 = {}, _a3["k-tabstrip-left"] = tabPosition === "left", _a3["k-tabstrip-right"] = tabPosition === "right", _a3["k-tabstrip-bottom"] = tabPosition === "bottom", _a3["k-tabstrip-top"] = tabPosition === "top", _a3));
    ...
    var renderContent = function renderContent2(currentTabProps) {
      ...
      return h(TabStripContent, __assign(__assign({}, tabContentProps), {
        attrs: this.v3 ? void 0 : __assign({}, tabContentProps)
      }), this.v3 ? function() {
        return defaultSlots;
      } : [defaultSlots]);
    };
...
var ref4 = allVue5.ref;
var inject4 = allVue5.inject;
var TabStripTabVue2 = {
  ...
  computed: {
    wrapperClass: function wrapperClass2() {
      ...
      return _a3 = {
        "k-card-actions": true,
        "k-actions": true
      }, _a3["k-actions-".concat(this.$props.layout)] = true, _a3["k-actions-".concat(this.$props.orientation !== cardOrientation.HORIZONTAL ? "vertical" : "horizontal")] = true, _a3;
    }
  },
    ...
    handleClick: function handleClick() {
      if (!this.disabled) {
        var handle = {
          element: this.$el,
          focus: this.focus,
          props: __assign2(__assign2({}, this.$props), this.$attrs)
        };
...
var DrawerNavigationVue2 = {
  ...
  render: function render16(createElement) {
    ...
    var defaultSlot = getDefaultSlots(this);
    var _a3 = this.kendoDrawer, animation = _a3.animation, expanded = _a3.expanded, mode = _a3.mode, position = _a3.position, mini = _a3.mini, dir = _a3.dir, width = _a3.width, miniWidth = _a3.miniWidth, items = _a3.items, header = _a3.header, footer = _a3.footer, content = _a3.content;
    ...
    var drawerItems = items && h("ul", {
      ...
      var itemRendering = getTemplate.call(this, {
        ...
        additionalProps: __assign3(__assign3({}, element), {
          index
        }),
        additionalListeners: {
          click: this.onSelect
...
var DrawerVue2 = {
  ...
  updated: function updated() {
    var _a3 = this.$props, expanded = _a3.expanded, mode = _a3.mode, position = _a3.position, animation = _a3.animation, mini = _a3.mini, width = _a3.width, miniWidth = _a3.miniWidth, items = _a3.items, item = _a3.item, navigationHeader = _a3.navigationHeader, navigationFooter = _a3.navigationFooter, navigationContent = _a3.navigationContent;
    var itemRender = item ? templateRendering.call(this, item, getListeners.call(this)) : void 0;
    var headerRender = navigationHeader ? templateRendering.call(this, navigationHeader, getListeners.call(this)) : void 0;
    var footerRender = navigationFooter ? templateRendering.call(this, navigationFooter, getListeners.call(this)) : void 0;
    var contentRender2 = navigationContent ? templateRendering.call(this, navigationContent, getListeners.call(this)) : void 0;
    ...
    this.drawer.content = contentRender2;
  },
...
function copyInputItemWithoutChildren(inputModel) {
  var result = {};
  var text = inputModel.text, url = inputModel.url, icon = inputModel.icon, svgIcon = inputModel.svgIcon, disabled = inputModel.disabled, cssClass = inputModel.cssClass, popupClass = inputModel.popupClass, cssStyle = inputModel.cssStyle, render50 = inputModel.render, linkRender = inputModel.linkRender, contentRender2 = inputModel.contentRender, data15 = inputModel.data;
  if (text !== void 0) {
    result.text = text;
  }
  if (url !== void 0) {
  ...
  if (render50 !== void 0) {
    result.render = templateRendering.call(this, render50, getListeners.call(this));
  }
...
var downArrowIcon = caretAltDownIcon;
var rightArrowIcon = caretAltRightIcon;
var leftArrowIcon = caretAltLeftIcon;
...
var MenuItemInternalVue2 = {
  ...
  computed: {
    ...
    currentOpened: function currentOpened() {
      ...
      return this.hasItems && shouldOpenItem(props.item.id, props.lastItemIdToBeOpened) && // HACK: Wait for the second render because otherwise the scenario of
  ...
  render: function render23(createElement) {
    ...
    var _a3 = this.$props.item, icon = _a3.icon, svgIcon = _a3.svgIcon, id = _a3.id, contentParentItemId = _a3.contentParentItemId, items = _a3.items, text = _a3.text, cssStyle = _a3.cssStyle, disabled = _a3.disabled, url = _a3.url;
    var itemId = id;
    var renderContent = function renderContent2() {
    ...
    var renderPopupIfOpened = function renderPopupIfOpened2() {
      var _this3 = this;
      var _a4 = getPopupSettings(itemId, this.$props.isMenuVertical, this.$props.isDirectionRightToLeft), anchorAlign = _a4.anchorAlign, popupAlign = _a4.popupAlign, collision = _a4.collision;
      return (
        // @ts-ignore function children
        h(Popup, {
          anchor: this._anchor,
    ...
    return h("li", {
      ...
      attrs: this.v3 ? void 0 : {
        ...
        "aria-haspopup": this.hasItems ? true : void 0,
...
var MenuVue2 = {
  ...
  destroyed: !!isV325 ? void 0 : function() {
  ...
  methods: {
    ...
    onItemMouseOver: function onItemMouseOver(itemId) {
      if (this.mouseOverHandler.IsMouseOverEnabled) {
        ...
        }, getHoverOpenDelay(__assign5({}, this.$props)));
      }
    },
    onItemMouseLeave: function onItemMouseLeave(itemId) {
      if (this.mouseOverHandler.IsMouseOverEnabled && this.isItemWithDefaultClose(itemId)) {
        ...
        }, getHoverCloseDelay(__assign5({}, this.$props)));
      }
    },
  ...
  methods: {
    ...
    mapPaneOptions: function mapPaneOptions(panes) {
      ...
      for (var index = 0; index < panes.length; index++) {
        ...
        paneOptions.push(__assign6(__assign6(__assign6({}, PANE_DEFAULTS), {
          orientation,
          overlay
        }), panes[index]));
      }
    ...
    onBarToggle: function onBarToggle(index, event) {
      ...
      var updatedState = panesOptions2.map(function(pane, idx) {
        var paneProps = pane;
        if (idx === index) {
          return __assign6(__assign6({}, paneProps), {
            collapsed: !pane.collapsed
          });
        } else {
          return __assign6({}, paneProps);
        }
      });
      this.$emit("change", {
...
var PanelBarGroupVue2 = {
  ...
  render: function render29(createElement) {
    ...
    var itemContent = opened || keepItemsMounted ? items ? h("ul", {
      ...
      return h(PanelBarItem, __assign7(__assign7({
        props: this.v3 ? void 0 : __assign7(__assign7({}, currentItem), {
          item
        })
      }, currentItem), {
        item
...
var renderChildren = function renderChildren2(items, _a3) {
  ...
  return items.map(function(child, idx) {
    ...
    return __assign9(__assign9({}, child), {
...
var PanelBarVue2 = {
  ...
  computed: {
    ...
    computedItems: function computedItems() {
      var state = __assign10(__assign10({
        currentExpanded: []
      }, this.$data), {
  ...
  render: function render31(createElement) {
    ...
    return h("ul", {
      ...
      return h(PanelBarItem, __assign10(__assign10({
        props: this.v3 ? void 0 : __assign10(__assign10({}, item), {
          item
        })
      }, item), {
        item
...
var AppBarVue2 = {
  ...
  computed: {
    wrapperClass: function wrapperClass6() {
      var _a3;
      var _b = this.$props, position = _b.position, positionMode = _b.positionMode, themeColor = _b.themeColor;
      return _a3 = {
        "k-appbar": true,
      ...
      }, _a3["k-appbar-".concat(themeColor)] = Boolean(themeColor), _a3;
    }
  },
  // @ts-ignore
...
var ref6 = allVue42.ref;
var inject6 = allVue42.inject;
...
var ActionSheetHeaderVue2 = {
  ...
  render: function render45(createElement) {
    ...
    var defaultSlot = getDefaultSlots(this);
    var _a3 = this.$props, headerStyle = _a3.headerStyle, headerClassName = _a3.headerClassName;
    return h("div", {
      style: headerStyle,
...
var ActionSheetVue2 = {
  ...
  updated: function updated5() {
    ...
    if (this.element) {
      if (this.$props.navigatable) {
        ...
        navigatableElements_1.length !== 0 ? this.navigation.focusElement(this.element.querySelector(navigatableElements_1[0]), null) : this.navigation.focusElement(this.navigation.first, null);
      }
    }
  },
  ...
  render: function render48(createElement) {
    ...
    var _a3 = this.$props, title = _a3.title, subTitle = _a3.subTitle, animationStyles = _a3.animationStyles, animation = _a3.animation, expand = _a3.expand, tabIndex = _a3.tabIndex, className = _a3.className, animationDuration = _a3.animationDuration, headerClassName = _a3.headerClassName, contentClassName = _a3.contentClassName, footerClassName = _a3.footerClassName;
...
//# sourceMappingURL=chunk-FJJ5WMMX.js.map
