import {
  FloatingLabel,
  TextBox
} from "./chunk-C7HAY3RD.js";
import {
  ActionSheet
} from "./chunk-FJJ5WMMX.js";
import {
...
var ListContainerVue2 = {
  ...
  render: function render(createElement) {
    ...
    var _a2 = this.$props, width = _a2.width, dir = _a2.dir, popupSettings = _a2.popupSettings;
    var popupClass = popupSettings.popupClass, className = popupSettings.className, animate = popupSettings.animate, anchor = popupSettings.anchor, anchorAlign = popupSettings.anchorAlign, show = popupSettings.show, itemsCount = popupSettings.itemsCount, appendTo = popupSettings.appendTo, collision = popupSettings.collision, direction = popupSettings.direction, offset = popupSettings.offset, popupAlign = popupSettings.popupAlign, style = popupSettings.style, popupWidth = popupSettings.width, popupStyle = popupSettings.popupStyle;
    return (
...
var ListFilterVue2 = {
  ...
  render: function render2(createElement) {
    ...
    var _a2 = this.$props, size = _a2.size, rounded = _a2.rounded, fillMode = _a2.fillMode, adaptiveMode = _a2.adaptiveMode;
    var listFilterComponent = function listFilterComponent2() {
      return h(TextBox, {
...
var ListItemVue2 = {
  ...
  render: function render4(createElement) {
    ...
    return getTemplate.call(this, {
      ...
      defaultRendering,
      additionalProps: __assign3(__assign3({}, this.$props), {
...
var ListGroupItemVue2 = {
  ...
  render: function render5(createElement) {
    ...
    return getTemplate.call(this, {
      ...
      template: this.$props.render,
      defaultRendering,
      additionalProps: __assign4({}, this.$props)
    });
  }
};
...
var adaptiveModeFooterApply = "dropdowns.adaptiveModeFooterApply";
var adaptiveModeFooterCancel = "dropdowns.adaptiveModeFooterCancel";
var messages = (_a = {}, _a[clear] = "clear", _a[expandButton] = "expand button", _a[nodata] = "NO DATA FOUND.", _a[selectButton] = "Select", _a[adaptiveModeFooterApply] = "Apply", _a[adaptiveModeFooterCancel] = "Cancel", _a);
...
var ListVue2 = {
  ...
  methods: {
    handleClick: function handleClick2(index, e) {
  ...
  function() {
    function VirtualScroll2() {
      ...
      this.calcScrollElementHeight = function() {
        ...
        var list = (_a2 = _this.container) === null || _a2 === void 0 ? void 0 : _a2.children[0];
  ...
  function() {
    ...
    DropDownBase2.prototype.calculatePopupWidth = function() {
      ...
      if (this.wrapper && !popupWidth) {
        this.component.popupWidth = props.popupSettings.width !== void 0 ? props.popupSettings.width : this.wrapper.offsetWidth + "px";
      }
    };
    ...
    DropDownBase2.prototype.applyState = function(state) {
      ...
      state.events.forEach(function(eventData) {
        ...
        if (type) {
          ...
          _this.component.$emit(type, __assign5(__assign5({}, eventArgs), eventData));
        }
      });
    };
    ...
    DropDownBase2.prototype.getTemplateDef = function(template, h) {
    ...
    DropDownBase2.prototype.getListItemHeight = function(listItem) {
      var compStyles = listItem && window.getComputedStyle(listItem);
      return compStyles ? compStyles.height.slice(0, compStyles.height.length - 2) : 0;
    };
...
var GroupStickyHeaderVue2 = {
  ...
  render: function render7(createElement) {
    ...
    var _a2 = this.$props, group = _a2.group, render20 = _a2.render;
...
// node_modules/@progress/kendo-vue-dropdowns/dist/es/common/constants.js
var MOBILE_SMALL_DEVICE = 500;
var MOBILE_MEDIUM_DEVICE = 768;
...
var DropDownListVue2 = {
  ...
  destroyed: !!isV38 ? void 0 : function() {
    if (this.observer) {
  ...
  render: function render8(createElement) {
    ...
    var _a2 = this.$props, style = _a2.style, className = _a2.className, label = _a2.label, dir = _a2.dir, _b = _a2.virtual, virtual4 = _b === void 0 ? {
      skip: 0
    } : _b, size = _a2.size, rounded = _a2.rounded, fillMode = _a2.fillMode, dataItemKey = _a2.dataItemKey, _c = _a2.dataItems, dataItems2 = _c === void 0 ? [] : _c, disabled = _a2.disabled, tabIndex = _a2.tabIndex, loading = _a2.loading, icon = _a2.icon, svgIcon = _a2.svgIcon, iconClassName = _a2.iconClassName, adaptiveTitle = _a2.adaptiveTitle, header = _a2.header, footer = _a2.footer, groupStickyHeaderItemRender = _a2.groupStickyHeaderItemRender;
    var opened5 = this.isOpen;
    ...
    var adaptiveActionSheetHeaderTemplateDef = function adaptiveActionSheetHeaderTemplateDef2() {
      return [h("div", {
    ...
    var adaptiveActionSheetContentTemplateDef = function adaptiveActionSheetContentTemplateDef2() {
      var _a3;
      ...
      return h("div", {
        ...
        "class": classNames("k-list", (_a3 = {}, _a3["k-list-".concat(sizeMap2[size] || size)] = !renderAdaptive ? size : false, _a3["k-list-lg"] = renderAdaptive ? true : false, _a3["k-virtual-list"] = vs.enabled, _a3))
      }, [renderDefaultItem.call(_this), _this.group && dataItems2.length !== 0 && h(GroupStickyHeader, {
        group: _this.group,
        attrs: this.v3 ? void 0 : {
          group: _this.group,
    ...
    var renderAdaptiveListContainer = function renderAdaptiveListContainer2() {
      ...
      return (
        ...
        h(ListContainer, {
          ...
          attrs: this.v3 ? void 0 : {
            ...
            popupSettings: __assign7(__assign7({}, popupSettings), {
    ...
    var dropdownlistDefault = function dropdownlistDefault2() {
      var _a3;
      return h("span", {
        ref: setRef(this, "kendoAnchor", this.anchor),
        "class": classNames("k-dropdownlist k-picker", className, (_a3 = {}, _a3["k-picker-".concat(sizeMap2[size] || size)] = size, _a3["k-rounded-".concat(roundedMap2[rounded] || rounded)] = rounded, _a3["k-picker-".concat(fillMode)] = fillMode, _a3["k-focus"] = focused, _a3["k-disabled"] = disabled, _a3["k-invalid"] = !isValid, _a3["k-loading"] = loading, _a3["k-required"] = this.required, _a3)),
        style: !label ? style : __assign7(__assign7({}, style), {
          width: void 0
        }),
        dir,
        attrs: this.v3 ? void 0 : {
    ...
    var dropdownlist = [isV38 ? h(dropdownlistDefault.call(this), __assign7({}, this.$attrs)) : dropdownlistDefault.call(this), renderAdaptive && renderAdaptiveListContainer.call(this)];
    var dropdownlistToRender = isV38 ? dropdownlist : renderAdaptive ? h("div", [dropdownlist]) : dropdownlistDefault.call(this);
    return label ? h("span", {
...
var ComboBoxVue2 = {
  ...
  methods: {
    ...
    calculateMedia: function calculateMedia2(entries) {
      for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
        var entry = entries_1[_i];
        this.windowWidth = entry.target.clientWidth;
      }
  ...
  render: function render11(createElement) {
    ...
    var _a2 = this.$props, dir = _a2.dir, disabled = _a2.disabled, clearButton = _a2.clearButton, label = _a2.label, textField = _a2.textField, className = _a2.className, style = _a2.style, loading = _a2.loading, icon = _a2.icon, svgIcon = _a2.svgIcon, iconClassName = _a2.iconClassName, virtual4 = _a2.virtual, size = _a2.size, fillMode = _a2.fillMode, rounded = _a2.rounded, adaptiveTitle = _a2.adaptiveTitle, header = _a2.header, footer = _a2.footer, groupStickyHeaderItemRender = _a2.groupStickyHeaderItemRender, placeholder = _a2.placeholder;
    var focused = this.currentFocused;
    var isValid = !this.$props.validityStyles || this.validity().valid;
    ...
    var handleMobileFilterChange = function handleMobileFilterChange2(event) {
    ...
    var adaptiveActionSheetContentTemplateDef = function adaptiveActionSheetContentTemplateDef2() {
      ...
      var footerToRender = base.getTemplateDef.call(_this, footer, h);
      var groupStickyHeaderTemplate = templateRendering.call(_this, groupStickyHeaderItemRender, getListeners.call(_this));
      var dataItems2 = _this.$props.dataItems || [];
      return h("div", {
        "class": "k-list-container"
      }, [headerToRender && h("div", {
        "class": "k-list-header"
      }, [headerToRender]), h("div", {
        "class": classNames("k-list", (_a3 = {}, _a3["k-list-".concat(sizeMap3[size] || size)] = !renderAdaptive ? size : false, _a3["k-list-lg"] = renderAdaptive ? true : false, _a3["k-virtual-list"] = vs.enabled, _a3))
      }, [header && h("div", {
        "class": "k-list-header"
      }, [header]), _this.group && dataItems2.length !== 0 && h(GroupStickyHeader, {
        group: _this.group,
        attrs: this.v3 ? void 0 : {
          group: _this.group,
          render: groupStickyHeaderTemplate
    ...
    var renderMobileListFilter = function renderMobileListFilter2() {
      var state = this.base.initState();
      ...
      return h(ListFilter, {
        ...
        value: mobileText,
        ref: "filterInput",
        onChange: function onChange5(ev) {
          return handleMobileFilterChange(ev);
        },
        on: this.v3 ? void 0 : {
          "change": function onChange5(ev) {
            return handleMobileFilterChange(ev);
          },
    ...
    var renderList = function renderList2() {
      var _this2 = this;
      var _a3;
      var _b = this.$props, dataItemKey = _b.dataItemKey, groupField = _b.groupField;
      ...
      return (
        ...
        h(List, {
          ...
          attrs: this.v3 ? void 0 : {
            ...
            wrapperStyle: {
              maxHeight: !renderAdaptive ? popupSettings.height : void 0
            },
    ...
    var renderListContainer = function renderListContainer2() {
      ...
      return (
        ...
        h(ListContainer, {
          ...
          attrs: this.v3 ? void 0 : {
            width: this.popupWidth,
            popupSettings: __assign8(__assign8({}, popupSettings), {
              anchor: this.anchor,
              show: opened5,
          ...
          return [headerListContainer && h("div", {
            "class": "k-list-header"
          }, [headerListContainer]), _this3.group && dataItems2.length !== 0 && h(GroupStickyHeader, {
            group: _this3.group,
            attrs: _this3.v3 ? void 0 : {
              group: _this3.group,
              render: groupStickyHeaderTemplate
    ...
    var renderSearchBar = function renderSearchBar2(searchText, searchId) {
      var _this2 = this;
      var _a3 = this.$props, tabIndex = _a3.tabIndex, _b = _a3.dataItems, dataItems2 = _b === void 0 ? [] : _b, dataItemKey = _a3.dataItemKey;
      if (!virtual4) {
        virtual4 = {
          skip: 0
        };
    ...
    var comboboxDefault = function comboboxDefault2() {
      var _a3;
      return h("span", {
        "class": classNames("k-combobox k-input", (_a3 = {}, _a3["k-input-".concat(sizeMap3[size] || size)] = size, _a3["k-rounded-".concat(roundedMap3[rounded] || rounded)] = rounded, _a3["k-input-".concat(fillMode)] = fillMode, _a3["k-invalid"] = !isValid, _a3["k-loading"] = loading, _a3["k-required"] = this.required, _a3["k-disabled"] = disabled, _a3["k-focus"] = focused && !disabled, _a3), className),
        ref: setRef(this, "kendoAnchor", this.anchor),
        style: !label ? style : __assign8(__assign8({}, style), {
          width: void 0
        }),
        dir,
        attrs: this.v3 ? void 0 : {
    ...
    var combobox = [isV311 ? h(comboboxDefault.call(this), __assign8({}, this.$attrs)) : comboboxDefault.call(this), renderAdaptive && renderAdaptiveListContainer.call(this)];
    var comboboxToRender = isV311 ? combobox : renderAdaptive ? h("div", [combobox]) : comboboxDefault.call(this);
    return label ? h("span", {
      "class": this.spanClassNames,
      onFocusin: this.handleFocus,
      on: this.v3 ? void 0 : {
...
var TagListVue2 = {
  ...
  render: function render13(createElement) {
    ...
    var defaultSlot = getDefaultSlots(this);
    var _a2 = this.$props, dataItems2 = _a2.dataItems, guid3 = _a2.guid, size = _a2.size, disabled = _a2.disabled, tagsRounded = _a2.tagsRounded, removeTagIcon = _a2.removeTagIcon, id = _a2.id, className = _a2.className;
    return h("div", {
      ...
      var _this = this;
      var uniqueId = "tag-".concat(guid3, "-").concat(tagData.text.toString().replace(/\s+/g, "-"));
...
var ref9 = allVue14.ref;
var inject4 = allVue14.inject;
...
var MultiSelectVue2 = {
  ...
  watch: {
    ...
    isOpen: function isOpen3(newValue) {
      var _this = this;
      if (newValue) {
        this.initialAdaptiveRenderingValues = this.base.component.currentValue;
      } else {
        this.initialAdaptiveRenderingValues = void 0;
      }
      setTimeout(function() {
        var listItem = document.querySelector(".k-list-item");
        _this.itemHeight = _this.base.getListItemHeight(listItem);
  ...
  destroyed: !!isV314 ? void 0 : function() {
    if (this.observer) {
      this.observer.disconnect();
    }
  },
  methods: {
    ...
    onChangeHandler: function onChangeHandler2(event) {
      var state = this.base.initState();
      var value2 = event && (event.currentTarget && event.currentTarget.value || event.value);
      var opened5 = this.isOpen;
      state.event = event;
      if (this.$props.filter === void 0) {
        state.data.currentText = value2;
    ...
    calculateMedia: function calculateMedia3(entries) {
      for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
        var entry = entries_1[_i];
        this.windowWidth = entry.target.clientWidth;
      }
  ...
  render: function render14(createElement) {
    ...
    var _a2 = this.$props, style = _a2.style, label = _a2.label, dir = _a2.dir, disabled = _a2.disabled, tags = _a2.tags, textField = _a2.textField, dataItemKey = _a2.dataItemKey, virtual4 = _a2.virtual, loading = _a2.loading, size = _a2.size, fillMode = _a2.fillMode, rounded = _a2.rounded, tagsRounded = _a2.tagsRounded, removeTagIcon = _a2.removeTagIcon, adaptiveTitle = _a2.adaptiveTitle, header = _a2.header, footer = _a2.footer, groupStickyHeaderItemRender = _a2.groupStickyHeaderItemRender, _b = _a2.dataItems, dataItems2 = _b === void 0 ? [] : _b;
    var focused = this.currentFocused;
    var popupSettings = Object.assign({}, {
      animate: true,
      height: "200px"
    ...
    if (!this.initialAdaptiveRenderingValues) {
      ...
      valuesBeforeAdaptiveRendering.forEach(function(item2) {
        tagsToRender.push({
          text: getItemValue(item2, textField),
          data: [item2]
        });
    ...
    var renderSearchBar = function renderSearchBar2(searchId) {
      ...
      var focusedIndex3 = this.getFocusedState().focusedIndex;
      var placeholderToShow = tagsToRender.length === 0 || value2.length === 0 && !searchText ? placeholder : void 0;
    ...
    var renderList = function renderList2() {
      ...
      var focusedIndex3 = this.getFocusedState().focusedIndex;
      var translate = "translateY(".concat(vs.translate, "px)");
      var listDataItems = dataItems2;
      if (groupField) {
        listDataItems = this.base.getGroupedDataModernMode(dataItems2, groupField);
      }
      return (
        // @ts-ignore  function children
        h(List, {
    ...
    var renderListContainer = function renderListContainer2() {
      ...
      return (
        ...
        h(ListContainer, {
          ...
          return [headerListContainer && h("div", {
            "class": "k-list-header"
          }, [headerListContainer]), customItem, _this3.group && dataItems2.length !== 0 && h(GroupStickyHeader, {
            group: _this3.group,
            attrs: _this3.v3 ? void 0 : {
              group: _this3.group,
              render: groupStickyHeaderTemplate
            ...
            "class": "k-list-footer"
          }, [footerListContainer]), virtual4 && header];
        } : [headerListContainer && h("div", {
          "class": "k-list-header"
        }, [headerListContainer]), customItem, _this3.group && dataItems2.length !== 0 && h(GroupStickyHeader, {
          group: _this3.group,
    ...
    var adaptiveActionSheetHeaderTemplate = templateRendering.call(this, adaptiveActionSheetHeaderTemplateDef, getListeners.call(this));
    var adaptiveActionSheetFooterTemplateDef = function adaptiveActionSheetFooterTemplateDef2() {
    ...
    var adaptiveActionSheetContentTemplateDef = function adaptiveActionSheetContentTemplateDef2() {
      ...
      return h("div", {
        ...
        "class": classNames("k-list", (_a3 = {}, _a3["k-list-".concat(sizeMap5[size] || size)] = !renderAdaptive ? size : false, _a3["k-list-lg"] = renderAdaptive ? true : false, _a3["k-virtual-list"] = vs.enabled, _a3))
      }, [_this.group && dataItems2.length !== 0 && h(GroupStickyHeader, {
        group: _this.group,
        attrs: this.v3 ? void 0 : {
          group: _this.group,
          render: groupStickyHeaderTemplate
    ...
    var multiSelectDefault = function multiSelectDefault2() {
      var _this4 = this;
      var _a3;
      return h("span", {
        ref: setRef(this, "kendoAnchor", this.anchor),
        "class": classNames("k-multiselect", "k-input", (_a3 = {}, _a3["k-input-".concat(sizeMap5[size] || size)] = size, _a3["k-rounded-".concat(roundedMap5[rounded] || rounded)] = rounded, _a3["k-input-".concat(fillMode)] = fillMode, _a3["k-focus"] = focused && !disabled, _a3["k-disabled"] = disabled, _a3["k-invalid"] = !isValid, _a3["k-loading"] = loading, _a3["k-required"] = this.required, _a3)),
        ...
        tagsToRender.length > 0 && clearButton && // @ts-ignore  function children
        h(ClearButton, {
          onClearclick: this.clearButtonClick,
          on: this.v3 ? void 0 : {
            "clearclick": this.clearButtonClick
    ...
    var multiselect = [isV314 ? h(multiSelectDefault.call(this), __assign11({}, this.$attrs)) : multiSelectDefault.call(this), renderAdaptive && renderAdaptiveListContainer.call(this)];
    var multiselectToRender = isV314 ? multiselect : renderAdaptive ? h("div", [multiselect]) : multiSelectDefault.call(this);
    return label ? h("span", {
      "class": this.spanClassNames,
      dir: this.$props.dir,
      attrs: this.v3 ? void 0 : {
...
var TreeViewItemVue2 = {
    ...
    var renderCheckbox = function renderCheckbox2() {
      ...
      if (this.$props.checkboxes) {
        ...
        return h("div", {
          ...
          "class": classNames("k-checkbox k-rounded-md", (_a2 = {}, _a2["k-checkbox-".concat(sizeMap6[size] || size)] = size, _a2["k-disabled"] = this.computedDisabled, _a2)),
          "aria-label": this.item.text,
          "aria-hidden": true,
  ...
  methods: {
    ...
    handlePress: function handlePress(e, subItem, subItemId) {
      this.$emit("press", e, subItem || __assign12({}, this.item), subItemId || this.itemId);
    },
...
var TreeViewVue2 = {
  ...
  render: function render16(createElement) {
    ...
    var size = this.$props.size;
    return h("div", {
      "class": classNames("k-treeview", (_a2 = {}, _a2["k-treeview-".concat(sizeMap7[size] || size)] = size, _a2["k-user-select-none"] = this.draggable, _a2["k-rtl"] = this.currentRtl, _a2)),
      onKeydown: this.onKeyDown,
      on: this.v3 ? void 0 : {
        "keydown": this.onKeyDown,
        "focusin": this.onFocus,
  ...
  methods: {
    ...
    dispatchEventsOnKeyDown: function dispatchEventsOnKeyDown(event, focusedItem2) {
      ...
      if (event.keyCode === Keys.left && this.fieldsSvc.expanded(focusedItem2) && isEnabled()) {
        this.dispatchExpandChange(event, focusedItem2, this.focusedItemId);
      } else if (event.keyCode === Keys.right && !this.fieldsSvc.expanded(focusedItem2) && (this.fieldsSvc.hasChildren(focusedItem2) || hasChildren(focusedItem2, this.$props.childrenField)) && isEnabled()) {
        this.dispatchExpandChange(event, focusedItem2, this.focusedItemId);
...
var DropDownTreeVue2 = {
  ...
  watch: {
    ...
    isOpen: function isOpen5(newValue) {
      if (newValue && this.value) {
        this.initialAdaptiveRenderingValues = __spreadArray2([], this.value, true);
      } else {
        this.initialAdaptiveRenderingValues = void 0;
      }
    }
  ...
  destroyed: !!isV319 ? void 0 : function() {
    if (this.observer) {
      this.observer.disconnect();
    }
  },
  ...
  render: function render18(createElement) {
    ...
    var _a2 = this.$props, dataItems2 = _a2.dataItems, dataItemKey = _a2.dataItemKey, popupSettings = _a2.popupSettings, disabled = _a2.disabled, placeholder = _a2.placeholder, label = _a2.label, name = _a2.name, selectField = _a2.selectField, subItemsField = _a2.subItemsField, validationMessage = _a2.validationMessage, valid = _a2.valid, required = _a2.required, validityStyles = _a2.validityStyles, adaptiveTitle = _a2.adaptiveTitle;
    ...
    var adaptiveActionSheetHeaderTemplateDef = function adaptiveActionSheetHeaderTemplateDef2() {
      return [h("div", {
        ...
        "class": "k-actionsheet-titlebar-group k-actionsheet-filter"
      }, [_this.$props.filterable && // @ts-ignore
      h(ListFilter, {
        tabindex: 0,
        attrs: this.v3 ? void 0 : {
          tabindex: 0,
          value: _this.$props.filter === void 0 ? _this.filterState : _this.$props.filter,
          size,
          rounded,
          fillMode
        },
    ...
    var adaptiveActionSheetContentTemplateDef = function adaptiveActionSheetContentTemplateDef2() {
      ...
      return [headerToRender && h("div", {
        "class": "k-list-header"
      }, [headerToRender]), dataItems2.length > 0 ? (
        // @ts-ignore
        h(TreeView, {
    ...
    var component = h("span", {
      ...
      !renderAdaptive && // @ts-ignore function children
      h(Popup, {
        style: {
          width: this.popupWidth,
          direction: dir
    ...
    var dropdowntreeToRender = isV319 ? dropdowntree : this.$props.adaptive ? h("span", [dropdowntree]) : component;
    return label ? (
      // @ts-ignore function children
      h(FloatingLabel, {
        label,
      ...
      } : [dropdowntreeToRender])
    ) : dropdowntreeToRender;
  },
  methods: {
    calculateMedia: function calculateMedia4(entries) {
      for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
        var entry = entries_1[_i];
        this.windowWidth = entry.target.clientWidth;
      }
    ...
    openPopup: function openPopup(event) {
      if (!this.isOpen) {
        var openEvent = __assign13({}, event);
    ...
    closePopup: function closePopup(event) {
      if (this.isOpen) {
        var closeEvent = __assign13({}, event);
        this.$emit("close", closeEvent);
        this.currentOpened = false;
      }
    },
    onWrapperClick: function onWrapperClick(event) {
      this.onFilterChange(__assign13(__assign13({}, event), {
        target: {
          value: ""
        }
      }));
...
var MultiSelectTreeVue2 = {
  ...
  computed: {
    ...
    tagsToRenderRef: function tagsToRenderRef() {
      ...
      if (this.initialAdaptiveRenderingValues === void 0) {
        ...
        return valuesBeforeAdaptiveRendering.length > 0 && valuesBeforeAdaptiveRendering.map(function(item2) {
          return {
            text: getItemValue(item2, _this.$props.textField),
            data: [item2]
          };
  ...
  watch: {
    // This watch gets the state of the data when the adaptive mode is activated
    isOpen: function isOpen7(newValue) {
      if (newValue && this.value) {
        this.initialAdaptiveRenderingValues = __spreadArray4([], this.value, true);
      } else {
        this.initialAdaptiveRenderingValues = void 0;
      }
    }
  ...
  render: function render19(createElement) {
    ...
    var id = this.$props.id || this.componentGuid;
    var _c = this.$props, dataItems2 = _c.dataItems, dataItemKey = _c.dataItemKey, _d = _c.popupSettings, popupSettings = _d === void 0 ? {} : _d, disabled = _c.disabled, placeholder = _c.placeholder, label = _c.label, name = _c.name, checkField = _c.checkField, checkIndeterminateField = _c.checkIndeterminateField, subItemsField = _c.subItemsField, validationMessage = _c.validationMessage, valid = _c.valid, value2 = _c.value, required = _c.required, validityStyles = _c.validityStyles, adaptiveTitle = _c.adaptiveTitle;
    var tabIndex = getTabIndex(this.$props.tabIndex, disabled);
    var localization = provideLocalizationService(this);
    ...
    var multiselecttreeToRender = isV320 ? multiselecttree : this.$props.adaptive ? h("span", [multiselecttree]) : component;
    return label ? (
      // @ts-ignore function children
      h(FloatingLabel, {
        label,
      ...
      } : [multiselecttreeToRender])
    ) : multiselecttreeToRender;
  },
  methods: {
    clearFilter: function clearFilter2(event) {
      this.onFilterChange(event, "");
    },
    onCancel: function onCancel2(event) {
      var dropdownEvent = {
        event,
        target: this
      };
      var changeEvent = __assign14({
        items: [],
        operation: "toggle",
    ...
    calculateMedia: function calculateMedia5(entries) {
      for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
        var entry = entries_1[_i];
        this.windowWidth = entry.target.clientWidth;
      }
    ...
    changeValue: function changeValue2(event, items, operation) {
      ...
      var value2 = getMultiSelectTreeValue(this.dataItems, __assign14(__assign14({}, fields), {
        items,
        operation,
        value: this.computedValue
      }));
    ...
    openPopup: function openPopup2(event) {
      if (!this.isOpen) {
        var openEvent = __assign14({}, event);
        this.$emit("open", openEvent);
    ...
    closePopup: function closePopup2(event) {
      ...
      if (this.isOpen) {
        var closeEvent = __assign14({}, event);
        this.$emit("close", closeEvent);
        if (this.opened === void 0) {
    ...
    onFilterChange: function onFilterChange2(event, emptyValue) {
...
//# sourceMappingURL=chunk-I3A4DYHS.js.map
