...
var G = defineComponent({
  ...
  setup(s, { emit: S }) {
    const o = s, d = S, a = {}, l = ref(), f = ref();
    function w() {
      try {
        return Te("mazIconPath");
      } catch {
        return;
      }
    }
    const m = computed(() => o.path ?? w()), y = computed(() => o.src ? o.src : m.value ? `${m.value}/${o.name}.svg` : `/${o.name}.svg`);
    onMounted(() => {
    ...
    function M(e) {
      return Object.keys(e).reduce((n, t) => (e[t] !== false && e[t] !== null && e[t] !== void 0 && (n[t] = e[t]), n), {});
    }
    function z(e) {
    ...
    async function x(e) {
      a[e] || (a[e] = L(e));
      try {
        l.value = await a[e], await nextTick(), d("loaded", f.value);
      } catch (n) {
    ...
    return watchEffect(() => x(y.value)), (e, n) => (openBlock(), createElementBlock(
      Fragment,
      null,
      [
        createCommentVNode(" eslint-disable vue/no-v-html "),
        createCommentVNode(" eslint-disable vue/html-self-closing "),
        l.value ? (openBlock(), createElementBlock("svg", mergeProps({
          key: 0,
          ref_key: "svgElem",
          ref: f,
          width: "1em",
          ...
          innerHTML: T(l.value)
        }), null, 16, H)) : createCommentVNode("v-if", true),
...
//# sourceMappingURL=MazIcon-CUOwXGOK-VGPIAH67.js.map
