<template>
  <div class="flex py-5 justify-between">
    ...
    >
      ...
      <div class="mb-5 mt-3 flex justify-between items-center w-96 gap-3">
        <div class="flex flex-col w-1/2">
          <base-label class="text-base font-medium"> First Name* </base-label>
          <KInput
            v-model="formData.username"
            type="email"
            class="bg-white h-10 rounded-md !w-full !px-2"
            :class="{
        ...
        <div class="flex flex-col w-1/2">
          <base-label class="text-base font-medium"> Last Name* </base-label>
          <KInput
            v-model="formData.username"
            type="email"
            class="bg-white h-10 rounded-md !w-full !px-2"
